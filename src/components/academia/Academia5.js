...
class Academia5 extends React.Component{
    ...
    constructor(props) {
        ...
        this.state = {
            ...
            selectedEndDatePast: '',
            academicObtainedMarksGraduate: '',
            academicTotalMarksGraduate: '',
            min: 0,
            max: 10,
    ...
    sendToStore(){
        ...
        this.props.dispatch(addAcademia5(this.state.id, {
            //typeOfStudentGraduate:this.state.typeOfStudentGraduate,
            ...
            programName:this.state.programNameGraduate,
            ...
            universityTwoPast:this.state.universityTwoPast,
    ...
    handleTypeOfStudent(evt, eventKey) {
        ...
        this.setState({
                typeOfStudentGraduate: eventKey.target.text
            },
            ()=> {
    ...
    handleProgramNameGraduate(evt) {
        this.setState({
                programNameGraduate: evt.target.value
            },
            ()=> {
                this.setStateCallBack();
            });
    ...
    handleUniversityTwo(evt) {
        this.setState({
                universityTwoPast: evt.target.value
            },
            ()=> {
                this.setStateCallBack();
            });
    ...
    handleStartDate(date) {
        ...
        this.setState({
                startDateGraduate: date,
                selectedStartDateGraduate: formattedDate
            },
            ()=> {
                this.setStateCallBack();
            });
    ...
    handleEndDate(date) {
        ...
        console.log(typeof formattedDate);
        this.setState({
                endDateGraduate: date,
                selectedEndDateGraduate: formattedDate
            },
            ()=> {
                this.setStateCallBack();
            });
    ...
    handleAcademicObtainedMarks(event) {
        this.setState({academicObtainedMarksGraduate: event.target.value},
            ()=> {
                this.setStateCallBack();
            });
    }
    ...
    handleAcademicTotalMarks(event) {
        this.setState({academicTotalMarksGraduate: event.target.value},
            ()=> {
                this.setStateCallBack();
            });
    }
    ...
    initiateCallFetch(){
        console.log("Academia5 Send Object");
        ...
        let objectAcademia5 = this.props.usersAbout[0].addAcademia5.users;



        let object = Object.assign(objectAcademia1, objectAcademia2, objectAcademia5);
...
export default connect(mapStateToProps)(Academia5);
